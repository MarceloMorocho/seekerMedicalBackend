...
public class FarmaciasControlador {
    ...
    // Método para validar la existencia del ruc
    ...
    // Método para validar que el correo electrónico pertenezca a la farmacia
    ...
    public ResponseEntity<String> validaCorreoPerteneceFarmacia(
        ...
        // Verifica si el correo electrónico pertenece a la farmacia con el ruc farRuc
    ...
    public ResponseEntity<Object> updateClave(@PathVariable String farRuc, @RequestBody FarmaciaRequest request) {
        ...
        // Envía el correo electrónico al administador de farmacia informándole que se ha cambiado la clave
